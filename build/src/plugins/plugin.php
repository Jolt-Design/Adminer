	...
	function _applyPlugin($function, $args) {
		foreach ($this->plugins as $plugin) {
			if (method_exists($plugin, $function)) {
                // START JG Modifications for Pretty Print plugin
                if (property_exists($plugin, 'adminer') && $plugin->adminer === null) {
                    $plugin->adminer = adminer();
                }
                // END JG Modifications for Pretty Print plugin
